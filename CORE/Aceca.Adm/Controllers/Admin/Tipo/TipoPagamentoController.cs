...
namespace Aceca.Adm.Controllers.Admin.Tipo
{
    public class TipoPagamentoController : Controller
    {
        ...
        public TipoPagamentoController(ILogger<TipoPagamentoController> logger, AppDbContext db, IWebHostEnvironment env, IConfiguration cfg)
        {
            _logger = logger;
            _db = db;
            _appEnvironment = env;
        ...
        {
            return View("~/Views/Admin/Tipo/TipoPagamento.cshtml");
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create(Models.TipoPagamento model)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    var newModel = new Models.TipoPagamento
                    {
                        Descricao = !string.IsNullOrEmpty(model.Descricao) ? model.Descricao : null,
                        Ativo = model.Ativo
                    };

                    _db.TipoPagamento.Add(newModel);
                    _db.SaveChanges();
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(Models.TipoPagamento model)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        public async Task<IActionResult> Delete(int id)
        {
            try
            {
                ...
                _db.TipoPagamento.Remove(model);
                _db.SaveChanges();
