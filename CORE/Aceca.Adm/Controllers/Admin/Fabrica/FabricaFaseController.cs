...
{
    public class FabricaFaseController : Controller
    {
        #region variaveis

        private readonly ILogger<FabricaFaseController> _logger;
        ...
        public FabricaFaseController(ILogger<FabricaFaseController> logger, AppDbContext db, IWebHostEnvironment env, IConfiguration cfg)
        {
            _logger = logger;
            _db = db;
            _appEnvironment = env;
        ...
        {
            return View("~/Views/Admin/Fabrica/FabricaFase.cshtml");
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create(Models.FabricaFase model)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(Models.FabricaFase model)
        {
            try
            {
                if (ModelState.IsValid)
