...
{
    public class MarcaImpressoraController : Controller
    {
        #region variaveis

        private readonly ILogger<MarcaImpressoraController> _logger;
        ...
        public MarcaImpressoraController(ILogger<MarcaImpressoraController> logger, AppDbContext db, IWebHostEnvironment env, IConfiguration cfg)
        {
            _logger = logger;
            _db = db;
            _appEnvironment = env;
        ...
        {
            return View("~/Views/Admin/Marca/MarcaImpressora.cshtml");
        }
        #endregion
        ...
        [HttpPost]
        public async Task<IActionResult> Create(Models.MarcaImpressora model)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    var newModel = new Models.MarcaImpressora
                    {
                        Descricao = !string.IsNullOrEmpty(model.Descricao) ? model.Descricao : null,
                        Ativo = model.Ativo
                    };

                    _db.MarcaImpressora.Add(newModel);
                    _db.SaveChanges();
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(Models.MarcaImpressora model)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        public async Task<IActionResult> Delete(int id)
        {
            try
            {
                ...
                _db.MarcaImpressora.Remove(model);
                _db.SaveChanges();
