...
{
    public class MarcaFabricaController : Controller
    {
        #region variaveis

        private readonly ILogger<MarcaFabricaController> _logger;
        ...
        public MarcaFabricaController(ILogger<MarcaFabricaController> logger, AppDbContext db, IWebHostEnvironment env, IConfiguration cfg)
        {
            _logger = logger;
            _db = db;
            _appEnvironment = env;
        ...
        {
            return View("~/Views/Admin/Marca/MarcaFabrica.cshtml");
        }
        #endregion
        ...
        [HttpPost]
        public async Task<IActionResult> Create(Models.MarcaFabrica model)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    var newModel = new Models.MarcaFabrica
                    {
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(Models.MarcaFabrica model)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        public async Task<IActionResult> Delete(int id)
        {
            try
            {
                ...
                var model = await _db.MarcaFabrica.AsNoTracking().FirstOrDefaultAsync(x => x.Id == id);
