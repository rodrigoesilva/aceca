...
{
    public class MarcaTipoController : Controller
    {
        #region variaveis

        private readonly ILogger<MarcaTipoController> _logger;
        ...
        public MarcaTipoController(ILogger<MarcaTipoController> logger, AppDbContext db, IWebHostEnvironment env, IConfiguration cfg)
        {
            _logger = logger;
            _db = db;
            _appEnvironment = env;
        ...
        {
            return View("~/Views/Admin/Marca/MarcaTipo.cshtml");
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create(Models.MarcaTipo model)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(Models.MarcaTipo model)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        public async Task<IActionResult> Delete(int id)
        {
            try
            {
                ...
                var model = await _db.MarcaTipo.AsNoTracking().FirstOrDefaultAsync(x => x.Id == id);
