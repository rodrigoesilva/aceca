...
{
    public class MarcaRaridadeController : Controller
    {
        #region variaveis

        private readonly ILogger<MarcaRaridadeController> _logger;
        ...
        public MarcaRaridadeController(ILogger<MarcaRaridadeController> logger, AppDbContext db, IWebHostEnvironment env, IConfiguration cfg)
        {
            _logger = logger;
            _db = db;
            _appEnvironment = env;
        ...
        {
            return View("~/Views/Admin/Marca/MarcaRaridade.cshtml");
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create(Models.MarcaRaridade model)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    var newModel = new Models.MarcaRaridade
                    {
                    ...
                    _db.MarcaRaridade.Add(newModel);
                    _db.SaveChanges();
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(Models.MarcaRaridade model)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        public async Task<IActionResult> Delete(int id)
        {
            try
            {
                ...
                _db.MarcaRaridade.Remove(model);
                _db.SaveChanges();
