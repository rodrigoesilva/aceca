...
{
    public class MarcaSubTipoController : Controller
    {
        #region variaveis

        private readonly ILogger<MarcaSubTipoController> _logger;
        ...
        public MarcaSubTipoController(ILogger<MarcaSubTipoController> logger, AppDbContext db, IWebHostEnvironment env, IConfiguration cfg)
        {
            _logger = logger;
            _db = db;
            _appEnvironment = env;
        ...
        {
            return View("~/Views/Admin/Marca/MarcaSubTipo.cshtml");
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create(Models.MarcaSubTipo model)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    var newModel = new Models.MarcaSubTipo
                    {
                        MarcaTipoId = model.MarcaTipoId,
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(Models.MarcaSubTipo model)
        {
            try
            {
                if (ModelState.IsValid)
