...
{
    public class PaisCategoriaController : Controller
    {
        #region variaveis

        private readonly ILogger<PaisCategoriaController> _logger;
        ...
        public PaisCategoriaController(ILogger<PaisCategoriaController> logger, AppDbContext db, IWebHostEnvironment env, IConfiguration cfg)
        {
            _logger = logger;
            _db = db;
            _appEnvironment = env;
        ...
        {
            return View("~/Views/Admin/Pais/PaisCategoria.cshtml");
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create(Models.PaisCategoria model)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    var newModel = new Models.PaisCategoria
                    {
                    ...
                    _db.PaisCategoria.Add(newModel);
                    _db.SaveChanges();
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(Models.PaisCategoria model)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        public async Task<IActionResult> Delete(int id)
        {
            try
            {
                ...
                _db.PaisCategoria.Remove(model);
                _db.SaveChanges();
