...
{
    public class AgendaImagemController : Controller
    {
        #region variaveis

        private readonly ILogger<AgendaImagemController> _logger;
        ...
        public AgendaImagemController(ILogger<AgendaImagemController> logger, AppDbContext db, IWebHostEnvironment env, IConfiguration cfg)
        {
            _logger = logger;
            _db = db;
            _appEnvironment = env;
        ...
        {
            return View("~/Views/Admin/Agenda/AgendaImagem.cshtml");
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create(Models.AgendaImagem model)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    var newModel = new Models.AgendaImagem
                    {
                        Imagem = model.Imagem,
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(Models.AgendaImagem model)
        {
            try
            {
                if (ModelState.IsValid)
