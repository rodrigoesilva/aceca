...
let var_Nome = 'F&aacute;brica',
    var_Controller = '/Fabrica',
...
function fn_LoadCmb_FabricaFase() {
    ...
    if ($('#cmb_FabricaFase').length <= 1) {
        $.ajax(
            {
                crossDomain: true,
                url: `${var_ControllerCmb}/AsyncCmb_FabricaFase`,
                type: 'GET',
                success: function (data) {
                    //console.log("fn_LoadCmb_FabricaFase  data ::: ", data);

                    $.each(data, function (id, result) {
                        //console.log("fn_LoadCmb_FabricaFase  result id ::: ", id);
                        //console.log("fn_LoadCmb_FabricaFase  result ::: ", result);
                        $("#cmb_FabricaFase").append($("<option></option>").val(result.value).html(result.text));
                    });
                },
...
function fn_PopGetObj() {
    ...
    const objFormData = {
        ...
        FabricaFaseId: $('#cmb_FabricaFase').val(),
