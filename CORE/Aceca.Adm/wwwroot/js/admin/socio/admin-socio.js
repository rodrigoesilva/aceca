...
function fn_Pop(obj, action) {
    ...
    // Open Pop
    if (obj === null) {
        var loadCmbs = fn_PopLoadCombos(action);
        // Open Pop
...
//#region COMBO
async function fn_PopLoadCombos(action) {
    //console.log("fn_PopLoadCombos  ::: ", action);
    /*
    if (await fn_LoadCmb_Exibidor(action)) {

        fn_LoadCmb_CinemaTipo();

        fn_LoadCmb_CinemaClassificacao();

        fn_LoadCmb_CinemaProgramacao();
    }
    else {
        Swal.fire({
            title: 'OPS!!',
            icon: 'error',
            html: `Falha no carregamento de Combos`,
            focusConfirm: false,
            confirmButtonText: `<i class="ri-check-double-line"></i>&nbsp;Ok!`,
            customClass: {
                confirmButton: 'btn btn-label-danger waves-effect'
...
async function fn_LoadCmb_Exibidor(action) {

    let var_FnReturn;
    //console.log("fn_LoadCmb_Exibidor action ::: ", action);
    //console.log("fn_LoadCmb_Exibidor length ::: ", $('.cinema_Exibidor').length);

    let cmb = action === 'Create' ? $('#pop_line_item_02') : $('#cinema_Exibidor');

    //if ($('.cinema_Exibidor').length <= 1) {
    if ($(cmb).length <= 1) {

        $.ajax(
            {
                crossDomain: true,
                url: `${var_ControllerCmb}/AsyncCmb_Exibidor`,
                type: 'GET',
                success: function (data) {
                    //console.log("fn_LoadCmb_Exibidor  data ::: ", data);

                    $.each(data, function (id, result) {
                        //console.log("fn_LoadCmb_Exibidor  result id ::: ", id);
                        //console.log("fn_LoadCmb_Exibidor  result ::: ", result);
                        //console.log("fn_LoadCmb_Exibidor  $(cmb) ::: ", $(cmb));

                        $(cmb).append($("<option></option>").val(result.value).html(result.text));
                    });

                    $.busyLoadFull("hide");

                    //return true;
                    //console.log("fn_LoadCmb_Exibidor  return ::: ", var_FnReturn);
                    // $("#cinema_Exibidor option[value='36']").attr("selected", "selected");

                    //console.log("fn_LoadCmb_Exibidor  exib ::: ", $("#cinema_Exibidor").val());
                },
                error: function (XMLHttpRequest, textStatus, errorThrown) {
                    console.log("XMLHttpRequest  :: ", XMLHttpRequest);
                    console.log("textStatus  :: ", textStatus);
...
function fn_LoadCmb_CinemaTipo() {

    if ($('#pop_line_item_03').length <= 1) {

        //console.log("fn_LoadCmb_CinemaTipo ::: ");

        $.ajax(
            {
                crossDomain: true,
                url: `${var_ControllerCmb}/AsyncCmb_CinemaTipo`,
                type: 'GET',
                success: function (data) {
                    //console.log("fn_LoadCmb_CinemaTipo  data ::: ", data);

                    $.each(data, function (id, result) {
                        //console.log("fn_LoadCmb_CinemaTipo  result id ::: ", id);
                        //console.log("fn_LoadCmb_CinemaTipo  result ::: ", result);
                        $("#pop_line_item_03").append($("<option></option>").val(result.value).html(result.text));
                    });
                },
...
function fn_LoadCmb_CinemaClassificacao() {

    if ($('#pop_line_item_04').length <= 1) {

        //console.log("fn_LoadCmb_CinemaClassificacao ::: ");

        $.ajax(
            {
                crossDomain: true,
                url: `${var_ControllerCmb}/AsyncCmb_CinemaClassificacao`,
                type: 'GET',
                success: function (data) {
                    //console.log("fn_LoadCmb_CinemaClassificacao  data ::: ", data);

                    $.each(data, function (id, result) {
                        //console.log("fnItemLoadFiltros  result id ::: ", id);
                        //console.log("fn_LoadCmb_CinemaClassificacao  result ::: ", result);
                        $("#pop_line_item_04").append($("<option></option>").val(result.value).html(result.text));
                    });
                },
                error: function (error) {
                    console.log(error);
...
function fn_LoadCmb_CinemaProgramacao() {

    if ($('#pop_line_item_05').length <= 1) {
        ...
        $.ajax(
            {
                crossDomain: true,
                url: `${var_ControllerCmb}/AsyncCmb_CinemaProgramacao`,
                type: 'GET',
                success: function (data) {
                    //console.log("fn_LoadCmb_CinemaProgramacao  data ::: ", data);

                    $.each(data, function (id, result) {
                        //console.log("fnItemLoadFiltros  result id ::: ", id);
                        //console.log("fn_LoadCmb_CinemaProgramacao  result ::: ", result);
                        $("#pop_line_item_05").append($("<option></option>").val(result.value).html(result.text));
                    });
                },
                error: function (error) {
                    console.log(error);
