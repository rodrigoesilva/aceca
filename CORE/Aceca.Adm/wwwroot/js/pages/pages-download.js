    ...
    if (varTbl_Obj.length) {
        ...
        varTbl_Data = varTbl_Obj.DataTable({
            ...
            columns: [
                ...
                { data: 'downloadTipo.descricao', className: 'text-center', width: '90px', responsivePriority: 2 },
                // COLUNA - Titulo (3ª a aparecer no mobile)
                { data: 'titulo', className: 'text-center', width: '120px', responsivePriority: 3 },
                // COLUNA - descricao
                ...
                {
                    data: 'socio.nome', className: 'text-center', responsivePriority: 10007,
                ...
                { targets: -2, data: 'socio.nome', visible: false, responsivePriority: 99 },
