                ...
                // COLUNA - Pais Categoria
                {
                    ...
                    render: function (data, type, full) {
                        ...
                        if (id != 0 && data !== undefined && data !== null) {
                            ...
                            let statusClass,
                                statusLayout,
                                statusDescricao = full.paisCategoria?.descricao,
                                paisCategoriaId = data;

                            switch (paisCategoriaId) {
                                case 1: //'Nivel 1'
...
function fn_LoadCmb_PaisCategoria() {
    ...
    if ($('#cmb_PaisCategoria').length <= 1) {
        $.ajax(
            {
                crossDomain: true,
                url: `${var_ControllerCmb}/AsyncCmb_PaisCategoria`,
                type: 'GET',
                success: function (data) {
                    //console.log("fn_LoadCmb_PaisCategoria  data ::: ", data);

                    $.each(data, function (id, result) {
                        //console.log("fn_LoadCmb_PaisCategoria  result id ::: ", id);
                        //console.log("fn_LoadCmb_PaisCategoria  result ::: ", result);
                        $("#cmb_PaisCategoria").append($("<option></option>").val(result.value).html(result.text));
                    });
                },
