/**
 * App -> Seguranca -> Permissoes - Tipo Permissao de Seguranca
 */
...
let var_Nome = 'Tipo de Permiss&otilde;es de Seguran&ccedil;a',
    var_Controller = '/TipoAdmPermissao',
        ...
        varTbl_Data = varTbl_Obj.DataTable({
            ...
            columnDefs: [
                ...
                // COLUNA - Ordem
                {
                    ...
                    className: "text-center",
                    render: function (data, type, full, meta) {
                        //console.log("Ordem data ::: ", data);
                        //console.log("Ordem type ::: ", type);
                        //console.log("Ordem full ::: ", full);
...
function fn_Pop(obj, action) {
    ...
    (popAddNewItem.querySelector('#hdId').value = (obj === null ? 0 : obj.Id)),
        ...
        (popAddNewItem.querySelector('.dt-line-03').checked = (obj === null ? false : obj.Ativo));
...
function fn_PopGetObj() {
    ...
    const objFormData = {
        ...
        Ativo: $('.form-add-new-item .dt-line-03').is(':checked')
    };
