...
function fn_Pop(obj, action) {
    ...
    (popAddNewItem.querySelector('#hdId').value = (obj === null ? 0 : obj.Id)),
        ...
        (popAddNewItem.querySelector('.dt-line-02').value = (obj === null ? '' : obj.Login)),
        (popAddNewItem.querySelector('.dt-line-03').value = (obj === null ? '' : obj.Email)),
        (popAddNewItem.querySelector('.dt-line-04').value = (obj === null ? '' : obj.TipoUsuario.Descricao)),
...
function fn_PopGetObj() {
    ...
    const objFormData = {
        ...
        TipoUsuario: $('.form-add-new-item .dt-line-04').val(),
